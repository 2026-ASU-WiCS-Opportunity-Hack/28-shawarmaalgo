...
export default function ActionLearningPage() {
  return (
    <ContentPage
      ...
      title="A disciplined process for solving real problems while learning"
      intro="Across the WIAL global and Nigeria sites, Action Learning is described as a new way of thinking, doing business, and interacting in teams."
      sections={[
        {
          title: "What it is",
