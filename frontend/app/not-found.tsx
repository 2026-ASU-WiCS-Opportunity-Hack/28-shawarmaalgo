  ...
  return (
    <PageShell>
      <div className="rounded-[2rem] border border-slate-200 p-10 text-center shadow-soft">
        ...
        <h1 className="mt-4 text-3xl font-bold text-brand-navy dark:text-white">That page does not exist yet.</h1>
        <p className="mt-4 text-slate-700 dark:text-slate-300">Use the shared route structure to add more global or country pages.</p>
