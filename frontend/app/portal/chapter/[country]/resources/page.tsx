...
export default async function ChapterResourcesPage({ params }: { params: { country: string } }) {
  ...
  if (!chapter) notFound();
  return (
    <PortalShell roleScope="chapter" eyebrow="Chapter leader console" title={`${chapter.name} resources`} description="Manage local chapter guides, downloads, and supporting materials displayed on the chapter resources page." chapterSlug={chapter.slug}>
