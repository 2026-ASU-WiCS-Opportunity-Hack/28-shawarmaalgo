...
export default async function ChapterCoachesPage({ params }: { params: { country: string } }) {
  ...
  if (!chapter) notFound();
  return (
    <PortalShell eyebrow="Chapter leader console" title={`${chapter.name} coaches`} description="Review coach profiles, update featured specialists, and coordinate visibility for chapter-level and global directory listings.">
